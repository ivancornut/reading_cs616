...
## Simple Schematic to read one sensor using a micro-controller
To convert the output of the sensor into something readable by a 3.3V µC we use a fast differential comparator, the LM311P. This idea was inspired by the design of a frequency counter found online [here](https://www.ee-diary.com/2022/07/high-frequency-counter-with-arduino.html#). Their design was adapted using an example circuit found in the datasheet of the comparator. 

![Comparator circuit](Schematic.png)
